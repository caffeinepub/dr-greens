        ...
        <div className="bg-primary px-6 pt-6 pb-5">
          <DialogHeader>
            ...
            <DialogDescription className="text-primary-foreground/75 text-sm mt-1.5 leading-relaxed">
              ...
              this to deliver your fresh microgreens right to your door.
            </DialogDescription>
          </DialogHeader>
        </div>
          ...
          >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Textarea
                  id="profile-location"
                  data-ocid="profile_setup.location_textarea"
                  value={form.location}
            ...
            <div className="space-y-1.5">
              ...
              <Input
                id="profile-maps"
                data-ocid="profile_setup.maps_link_input"
                type="url"
