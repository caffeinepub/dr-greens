...
actor {
  ...
  public query ({ caller }) func getOrderStats() : async Stats {
    ...
    for (o in orders.values()) {
      total += 1;
      rev += o.totalPrice;
      if (o.status == "pending") { pend += 1 } else if (o.status == "processing") { proc += 1 } else if (o.status == "delivered") { deliv += 1 } else if (o.status == "cancelled") { canc += 1 };
    };
    {
      totalOrders = total;
      totalRevenue = rev;
  ...
  public query ({ caller }) func exportOrdersCSV() : async Text {
    ...
    for (o in orders.values()) {
      csv #= o.id.toText() # "," # o.productName # "," # o.customerName # "," # o.email # "," # o.phone # "," # o.quantity.toText() # "," # o.totalPrice.toText() # "," # o.status # "," # "\"" # o.notes # "\"" # "," # o.createdAt.toText() # "\n";
    };
    csv;
  };
